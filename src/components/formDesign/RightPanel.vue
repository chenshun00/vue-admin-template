<template>
  <div class="right-board">
    ...
    <div class="field-box">
<!--      <a class="document-link" target="_blank" :href="documentLink" title="查看组件文档" type="hidden" hidden="hidden">-->
...
import TreeNodeDialog from '@/components/formDesign/TreeNodeDialog.vue'
